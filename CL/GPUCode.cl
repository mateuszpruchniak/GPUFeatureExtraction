...
void setDataInt(__global int* data, int insert, int iDevGMEMOffset)
{
	data[iDevGMEMOffset] = insert;
}

int GetDataFromGlobalMemoryInt( __global int* data,  int iDevGMEMOffset)
{
	return data[iDevGMEMOffset];
}
