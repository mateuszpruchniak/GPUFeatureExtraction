...
Orientation::Orientation(cl_context GPUContext ,GPUTransferManager* transfer): ContextFilter("C:\\Users\\Mati\\Desktop\\Dropbox\\MGR\\GPUFeatureExtraction\\GPU\\OpenCL\\Orientation.cl","ckOrien")
{
...
bool Orientation::filter(cl_command_queue GPUCommandQueue, IplImage* a, IplImage* b, IplImage* c )
{
	return false;
}

bool Orientation::filter(cl_command_queue GPUCommandQueue, float sigma = 0)
{
...
bool Orientation::filter(cl_command_queue GPUCommandQueue, IplImage* a, IplImage* b)
{
	return false;
}