...
void SIFT::BuildScaleSpace()
{
	...
	for(i=0;i<m_numOctaves; i++ )
	{
		...
		for(j=1;j<m_numIntervals+3;j++)
		{
			...
			sprintf(filename, "C:\\Users\\Mati\\Pictures\\g_octave_%d_scale_%d.jpg", i, j);
			SaveFloatingPointImage(filename, m_gList[i][j]);
			
			sprintf(filename, "C:\\Users\\Mati\\Pictures\\dog_octave_%d_scale_%d.jpg", i, j-1);
